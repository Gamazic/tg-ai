...
У каждого чата есть собственный баланс. Пополнить его можно командой
`/pop_up <сумма>`. Каждый вызов ИИ списывает стоимость с этого баланса.
Посмотреть суммарные траты можно через команду `/spent`.
